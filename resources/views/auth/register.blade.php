...
@section('content')
    <section class="min-h-175 flex flex-row items-center justify-center my-15">
            ...
            <form method="POST" action="/register" class="flex flex-col gap-5">
                ...
                <article>
                    ...
                    <input type="text" name="login" value="{{ old('login') }}"
                        class="bg-white w-full px-4 py-2 border border-gray-400 rounded-lg focus:outline-none"
                        placeholder="Логин">
                </article>
                ...
                <article>
                    ...
                    <input type="text" name="fio" value="{{ old('fio') }}"
                        class="bg-white w-full px-4 py-2 border border-gray-400 rounded-lg focus:outline-none"
                        placeholder="Кумушкин Иван Петрович">
                </article>
                ...
                <button type="submit"
                    class="cursor-pointer self-center bg-teal-700 text-white font-semibold px-15 py-3 rounded-lg hover:bg-teal-800 transition-colors">
                    Зарегистрироваться
                </button>
            </form>

            <p class="mt-4 text-center text-sm">
                <a href="/login" class="text-amber-500 text-xs hover:underline">Уже зарегистрированы? <span
                        class="font-bold">Войти</span></a>
            </p>
        </article>
    </section>
@endsection
